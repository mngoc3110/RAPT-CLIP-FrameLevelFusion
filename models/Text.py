...
# Simple prompt ensemble for EMOTIC
prompt_ensemble_emotic_26 = []
for cls in class_names_emotic:
    prompt_ensemble_emotic_26.append([
        f"a photo of a person feeling {cls}.",
        f"a video of a person showing {cls}.",
        f"a person expressing {cls}.",
        f"the person is feeling {cls}.",
        f"a face showing {cls}.",
        f"a portrait of a person showing {cls}.",
        f"a picture of a person experiencing {cls}.",
        f"a photo of {cls} emotion."
    ])
